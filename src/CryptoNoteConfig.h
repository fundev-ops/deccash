...
const uint64_t DIFFICULTY_TARGET_V2                          = 240; // seconds

const uint32_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 500000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 500000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 1000000000;
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x6477f4b58;
...
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX                 = 20000;
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V2              = 25000;
...
const unsigned EMISSION_SMOOTHING_FACTOR_V2                  = 23;
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(450000000000);
...
const char     CRYPTONOTE_NAME[]                             = "deccash";
...
const int      P2P_DEFAULT_PORT                              =  63218; // 29888
const int      RPC_DEFAULT_PORT                              =  63219; // 29889
...
const char* const SEED_NODES[] = { "167.86.94.121:63218", "192.187.106.179:63218" };
